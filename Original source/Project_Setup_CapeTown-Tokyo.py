...
xpl = [(x[0] + 45.0)] 
ypl = [(y[0] - 4.0)]
xmi = [0, (x[1] + 5.5)]    # 0 slot is always 0 (starts at position 1 in more general Bezier algorithm)
ymi = [0, (y[1] - 35.75)]    # 0 slot is always 0 (starts at position 1 in more general Bezier algorithm)

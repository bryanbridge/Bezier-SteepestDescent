...
xpl = [(x[0] + 0.4)] 
ypl = [(y[0] - 2.0)]
xmi = [0, (x[1] + 3.5)]    # 0 slot is always 0 (starts at position 1 in more general Bezier algorithm)
ymi = [0, (y[1] + 0.0)]    # 0 slot is always 0 (starts at position 1 in more general Bezier algorithm)
